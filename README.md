...
2. Aggregated data to weekly SKU-level demand.
3. Selected top 15 SKUs by total sales volume.
4. Created a complete 105-week time-series panel per SKU.
5. Filled missing weeks with zero demand.
6. Forward-filled price and discount features for continuity.
